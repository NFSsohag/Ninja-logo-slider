...
if( ! class_exists( 'NINJAPlugins_logo_free' ) ){
    
    class NINJAPlugins_logo_free{
        ...
        public function __construct() {
            add_action( 'admin_menu', array( $this, 'ninja_plugins_free_menu' ) );
        }
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof NINJAPlugins_logo_free ) {
                self::$_instance = new NINJAPlugins_logo_free();
            }
            
            return self::$_instance;
        }
                
        public function ninja_plugins_free_menu() {
            ...
            add_submenu_page( 
                ...
                'manage_options', 
                'ninja-plugins-free', 
                array( $this, 'ninjacoach_free_menu_cb' )
                );
        }
        
        public function ninjacoach_free_menu_cb() { ?>	  
			...
			<div class="panel panel-primary panel-default content-panel">
				...
				<table class="form-table2">
					<tr class="radio-span" style="border-bottom:none;">
						...
						?>
						<form id="ninjap-recommended" class="layout-form">
							<div id="poststuff">
								<div id="post-body" class="metabox-holder">
									<div id="postbox-container-2" class="postbox-container">
										<div id="advanced" class="meta-box-sortables">
											<div id="ninja_plugins_free" class="postbox" >
												<div class="handlediv" data-target="ux_recommendation" title="Click to toggle" data-toggle="collapse"><br></div>
												<h2 class="hndle">NINJA Plugins - recommended more free plugins</h3>
												<div class="inside">
													<div id="ninjap_recommendation" class="ninjap-recommendation">
    ...
    $ninjaplugin_free = NINJAPlugins_logo_free::get_instance();
}